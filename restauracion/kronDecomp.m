...
% is, the singular vectors corresponding to the largest singular value of
% P should have nonnegative entries. The next few statements check this,
% and change sign if necessary.
%
minU = abs(min(U(:,1)));
maxU = max(abs(U(:,1)));
if minU == maxU
